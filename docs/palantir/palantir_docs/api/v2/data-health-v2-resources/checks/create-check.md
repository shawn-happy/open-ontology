...
| 错误码 | 错误名称 | 说明 |
| --- | --- | --- |
| CONFLICT | `CheckAlreadyExists` | A check of the given type for the given subject(s) already exists. The conflicting check will be returned<br>if the provided token has permission to view it. |
...
| PERMISSION_DENIED | `CreateCheckPermissionDenied` | Could not create the Check. |
