...
| `branch` | string | 否 | The Foundry branch to list linked objects from. If not specified, the default branch will be used.<br>Branches are an experimental feature and not all workflows are supported.<br>示例: `ri.branch..branch.d827184f-ee0e-4351-8b70-efbe51e07252` |
...
| `ListLinkedObjectsResponseV2.data` | list<OntologyObjectV2> | 否 | — |
| `ListLinkedObjectsResponseV2.data.OntologyObjectV2` | map | 是 | Represents an object in the Ontology. |
| `ListLinkedObjectsResponseV2.data.OntologyObjectV2.PropertyApiName` | string | 是 | The name of the property in the API. To find the API name for your property, use the `Get object type`<br>endpoint or check the **Ontology Manager**. |
