...
| 参数 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `GroupMembershipExpirationPolicy` | object | 是 | The replaced GroupMembershipExpirationPolicy<br>示例: `{"maximumDuration":30,"maximumValue":"2026-01-31T00:00:00.000Z"}` |
...
| 错误码 | 错误名称 | 说明 |
| --- | --- | --- |
| PERMISSION_DENIED | `ReplaceGroupMembershipExpirationPolicyPermissionDenied` | Could not replace the GroupMembershipExpirationPolicy. |
