...
| INVALID_ARGUMENT | `CreateConfigValidationError` | The provided configuration is invalid. |
| PERMISSION_DENIED | `CreateModelStudioConfigVersionPermissionDenied` | Could not create the ModelStudioConfigVersion. |
