...
| `modelStudioConfigVersionVersion` | integer | 是 | The version number of this configuration.<br>示例: `1` |
...
| NOT_FOUND | `ModelStudioConfigVersionNotFound` | The given ModelStudioConfigVersion could not be found. |
