...
| `ListTransactionsOfDatasetResponse.data` | list<Transaction> | 否 | — |
| `ListTransactionsOfDatasetResponse.data.Transaction` | object | 是 | — |
| `ListTransactionsOfDatasetResponse.data.Transaction.rid` | string | 是 | The Resource Identifier (RID) of a Transaction.<br>示例: `ri.foundry.main.transaction.0a0207cb-26b7-415b-bc80-66a3aa3933f4` |
| `ListTransactionsOfDatasetResponse.data.Transaction.transactionType` | enum | 是 | The type of a Transaction.<br>示例: `APPEND` |
| `ListTransactionsOfDatasetResponse.data.Transaction.status` | enum | 是 | The status of a Transaction.<br>示例: `COMMITTED` |
| `ListTransactionsOfDatasetResponse.data.Transaction.createdTime` | string | 是 | The timestamp when the transaction was created, in ISO 8601 timestamp format.<br>示例: `2020-09-30T14:30:00Z` |
| `ListTransactionsOfDatasetResponse.data.Transaction.closedTime` | string | 否 | The timestamp when the transaction was closed, in ISO 8601 timestamp format.<br>示例: `2020-09-30T21:00:00Z` |
