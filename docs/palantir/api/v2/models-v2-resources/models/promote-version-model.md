...
```json
{
  "sourceModelVersionRid": "ri.models.main.model-version.adf94926-c3ac-41ea-beb2-4946699d08ee",
  "branch": "master"
}
```
...
| PERMISSION_DENIED | `PromoteVersionModelPermissionDenied` | Could not promoteVersion the Model. |
