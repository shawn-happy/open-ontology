...
| 错误码 | 错误名称 | 说明 |
| --- | --- | --- |
| PERMISSION_DENIED | `ReplaceSchedulePermissionDenied` | Could not replace the Schedule. |
