...
| INVALID_ARGUMENT | `CreateFolderOutsideProjectNotSupported` | The given resource is not a folder. |
...
| INVALID_ARGUMENT | `MissingDisplayName` | A Display Name must be provided. |
| PERMISSION_DENIED | `CreateFolderPermissionDenied` | Could not create the Folder. |
