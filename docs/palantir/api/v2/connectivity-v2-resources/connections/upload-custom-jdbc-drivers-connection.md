...
| 参数 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `fileName` | string | 是 | The file name of the uploaded JDBC driver. Must end with .jar<br>示例: `cdata.jdbc.oracle.jar` |
...
| 错误码 | 错误名称 | 说明 |
| --- | --- | --- |
| PERMISSION_DENIED | `UploadCustomJdbcDriversConnectionPermissionDenied` | Could not uploadCustomJdbcDrivers the Connection. |
