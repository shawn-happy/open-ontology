...
| 错误码 | 错误名称 | 说明 |
| --- | --- | --- |
| INVALID_ARGUMENT | `SecretNamesDoNotExist` | The secret names provided do not exist on the connection. |
| PERMISSION_DENIED | `UpdateSecretsForConnectionPermissionDenied` | Could not updateSecrets the Connection. |
