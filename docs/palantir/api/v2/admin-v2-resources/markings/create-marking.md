...
| INVALID_ARGUMENT | `CreateMarkingMissingInitialAdminRole` | At least one ADMINISTER role assignment must be provided when creating a marking. |
...
| PERMISSION_DENIED | `CreateMarkingPermissionDenied` | Could not create the Marking. |
